    ...
    <div>
      <h2>check your details</h2>
        <ListGroup style={{maxWidth:'600px' , margin:'auto'}}>
          <ListGroupItem variant="secondary">First Name:{firstName}</ListGroupItem>
          ...
          <ListGroupItem variant="secondary">NIC Number:{nicNumber}</ListGroupItem>
          <ListGroupItem variant="secondary">Date Of Birth:{dateOfBirth}</ListGroupItem>
          ...
          <ListGroupItem variant="secondary">BloodGroup:{bloodGroup}</ListGroupItem>
          <ListGroupItem variant="secondary">HealthUpdates:{healthupdates}</ListGroupItem>
